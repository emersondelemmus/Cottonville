...
% This test phase gauges the model's generalization ability, essential for real-world applications. The test phase performances are presented in a confusion matrix in \emph{Table \ref{table:MNCM}}.
...
The same 106 test images used for MobileNetV3 were also isolated to evaluate NASNetMobile's accuracy. It is imperative to note that high training metrics don't assure optimal test performance. %NASNetMobile's confusion matrix is displayed in \emph{Table \ref{table:NNMCM}}.
